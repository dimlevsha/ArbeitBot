...
const english = {
  ...
  missingFreelancerMessage: '\n\nВаш профиль заполнен не полностью, вы не можете получать задания! Пожалуйста, напишите информацию "О себе", выберите свой язык, примерную сумму, за которую готовы работать, а также категории деятельности, в которых хотели бы сотрудничать.',
