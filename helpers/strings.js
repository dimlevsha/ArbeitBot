...
module.exports = {
  ...
  helpMessage: 'Вас приветствует команда JobMaker!\n\nIДля того, чтобы эффективно пользоваться JM, Вам необходимо для начала заполнить свой профиль через графу "О себе", затем добавить язык , интересующую Вас оплату услуг, желаемые категории, которые наиболее привлекательны для Вас.\n\nС помощью JM Вы можете как искать работу, используя графу "Категории", так и искать исполнителей Ваших задач через графы "Задания" и "Создать задание".\n\nПо всем интересующим вопросам просьба обращаться к @dsl1500.\n\nЖелаем удачного поиска!',
  ...
  reviewFreelancerMessage: 'Оценить сообщение исполнителя',
  reviewClientMessage: 'Оценить сообщение заказчика',
