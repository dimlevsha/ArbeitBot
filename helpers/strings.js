...
const english = {
  ...
  helpMessage: '  Вас приветствует команда JobMaker FEFU!🎉\n\n Пользуясь нашим сервисом, вы автоматически подтверждаете, что прочитали наши правила и соглашаетесь с ними.⚠⚠⚠\n\n    Всю доступную информацию вы можете прочитать, нажав на кнопки "Правила", "Как найти задание", "Как создать задание", представленные ниже👇\n\n    Дополнительно мы можем вам предложить установить русский язык для Telegram, если вы пользователь опреационной системы ios. Для этого нажмите на\n👉/ios \n\nЖелаем удачного поиска!🔎',
  ...
  pickFreelancersMessage: 'Пожалуйста, выберите тех, кому отправить предложение о выполнении работы. Список людей находится ниже👇',
  ...
  selectCandidateMessage: 'Выберите исполнителя, который вам нравится больше всего. Список людей находится ниже👇',
...
const russian = {
  resubscribe: 'Переподписаться',
  unsubscribe: 'Отписаться от рассылок(Не рекомендуется)',
  hideButtons: 'Оставить рассылки от администратора',
  jobCreationFindFreelancerReminderMessage1: 'Похоже, Вы вчера создали работу:',
  jobCreationFindFreelancerReminderMessage2: 'но так и не выбрали фрилансера. Если Вам нужна какая-либо помощь или у Вас есть какие-либо вопросы, пожалуйста, напишите нам в техподдержку, нажав на кнопку ниже. Спасибо!',
