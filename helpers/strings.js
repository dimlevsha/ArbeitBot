...
module.exports = {
  ...
  deprecatedMessage: 'Пролестните страницу вниз ??',
  initialMessage: 'Добро пожаловать, это Job Maker DVFU! Мы рады, что вы пользуетесь нашими услугами и надеемся, что вы тоже останетесь довольны! (???)	',
