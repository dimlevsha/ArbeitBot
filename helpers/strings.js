...
module.exports = {
  ...
  missingBecameBusyMessage: 'Вы изменили свой статус на "Занят(а). Но это не имеет значение, так как вы не заполнили профиль и не сможете получать задания. Заполните профиль!(/◔ ◡ ◔)/',
