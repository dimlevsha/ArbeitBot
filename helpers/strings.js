...
module.exports = {
  ...
  missingBecameBusyMessage: 'Вы изменили свой статус на "Занят(а). Но это не имеет значения, если  вы не заполнили профиль, так как не сможете получать задания.',
  missingBecameAvailableMessage: 'Вы изменили свой статус на "Доступен(а)". Но это не имеет значения, если  вы не заполнили профиль, так как не сможете получать задания.',
  ...
  hourlyRateOptions: [
    '0р – 50р', '50р – 250р', '250р – 500р',
    '500р – 1000р', '1000р – 5000р',
  ],
